    ...
    <div class="mx-auto max-w-2xl px-4 py-10">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl font-black text-slate-900">Add Member</h1>
            </div>
            <a href="{{ route('dashboard') }}"
                class="rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white">Back to Dashboard</a>
        </div>

        <form method="POST" action="{{ route('members.store') }}" class="space-y-5 rounded-2xl bg-white p-6 shadow">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="phone" class="w-full rounded-lg border border-slate-300 px-3 py-2">
            </div>
            ...
            <div>
                ...
                <input type="date" name="join_date" class="w-full rounded-lg border border-slate-300 px-3 py-2">
            </div>
